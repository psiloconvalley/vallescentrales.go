...
// search_vector is excluded — it is generated by PostgreSQL, never read directly.
type Listing struct {
...
// CanPublish returns true if the listing meets minimum requirements to go active.
// ADR-004: title, property_type, price_mxn, municipality, at least 1 photo.
